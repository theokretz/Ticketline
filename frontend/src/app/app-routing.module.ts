...
const routes: Routes = [
  ...
  { path: 'reset/:token', canActivate: [AuthGuard], component: ResetComponent },
  { path: 'performances/:id', canActivate: [AuthGuard],component: PerformanceComponent },
  { path: 'performances/location/:id',canActivate: [AuthGuard], component: PerformanceOnLocationComponent},
  ...
  { path: ':id/event',canActivate: [AuthGuard], component: EventDetailsComponent },
